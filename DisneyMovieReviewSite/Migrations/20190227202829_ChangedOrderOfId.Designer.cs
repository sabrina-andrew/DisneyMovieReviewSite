...
namespace DisneyMovieReviewSite.Migrations
{
    ...
    [Migration("20190227202829_ChangedOrderOfId")]
    partial class ChangedOrderOfId
    {
            ...
            modelBuilder.Entity("DisneyMovieReviewSite.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, CategoryName = "Animation", Description = "Animation description" },
                        new { ID = 2, CategoryName = "Pixar", Description = "Pixar description" },
                        new { ID = 3, CategoryName = "Live Action", Description = "Live Action Description" }
                    );
                });
