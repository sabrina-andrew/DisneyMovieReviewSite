...
namespace DisneyMovieReviewSite.Migrations
{
    ...
    [Migration("20190304162449_AddedReviewToMovieDetails")]
    partial class AddedReviewToMovieDetails
    {
            ...
            modelBuilder.Entity("DisneyMovieReviewSite.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new { MovieID = 1, CategoryID = 1, ImgPath = "/Images/TheLittleMermaid.jpg", Name = "The Little Mermaid", Rating = 5.0, ReleaseYear = 1989, RunTime = 85, Synopsis = "A mermaid named Ariel falls in love with a human prince, and must find her destiny with the help of family and friends.", UserName = "Mr. Whiplash" },
                        new { MovieID = 2, CategoryID = 1, ImgPath = "/Images/Aladdin.jpeg", Name = "Aladdin", Rating = 4.0, ReleaseYear = 1992, RunTime = 91, Synopsis = "Aladdin, a streetwise nobody from the land of Agrabah, finds a magical lamp that will allow his every wish to be granted. He must find a way to stop the evil Jafar and win the love of Princess Jasmine.", UserName = "DisneyFanatic23" },
                        new { MovieID = 3, CategoryID = 1, ImgPath = "/Images/LionKing.jpeg", Name = "Lion King", Rating = 4.0, ReleaseYear = 1994, RunTime = 89, Synopsis = "Simba is a young lion set to inherit the kingdom from his father, Mufasa. When Simba's evil uncle Scar betrays him, Simba escapes into exile, and must find the courage to reclaim his birthright.", UserName = "DisneyLover" },
                        new { MovieID = 4, CategoryID = 2, ImgPath = "/Images/ToyStory.jpg", Name = "Toy Story", Rating = 4.0, ReleaseYear = 1995, RunTime = 81, Synopsis = "A cowboy doll is profoundly threatened and jealous when a new spaceman figure supplants him as top toy in a boy's room.", UserName = "DisneyReviewer" }
                    );
                });
